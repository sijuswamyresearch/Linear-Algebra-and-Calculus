...
## Tutorial 4:  Principal Axis Transformation of Quadratic Forms
...
**Problem 1:** The energy stored in a coupled capacitor system is given by: 
$$
5x_1^{2}+4x_1x_2+3x_2^{2}=10
$$
Transform to principal-axis form, find the orthogonal transformation $X=\hat{B}Y$, classify the conic, and give $Y=B^{-1}X$.
...
**Problem 4:** A quadratic classifier is modeled by: 
$$
...
**Problem 5:** A Lyapunov function candidate is: 
$$
