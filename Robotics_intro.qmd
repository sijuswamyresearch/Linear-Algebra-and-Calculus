---
title: "Mathematics in Robotics: Linear Algebra & Calculus in Action"
...
::: incremental
- **Linear Algebra** → robot arm kinematics, transformations
- **Calculus** → motion, velocity, optimization
...
## Forward Kinematics — 2D Robot (Geometry)
...
|---------------------|----------------------------------------------------|--------------------------------------|
| **Jacobian Matrix** | Relates joint velocities → end-effector velocities | Lose control in some directions       |
...
At certain configurations, the Jacobian matrix loses rank →  robot loses degrees of freedom.
...
- A clear path from **mathematical concepts → practical robotics solutions**  
