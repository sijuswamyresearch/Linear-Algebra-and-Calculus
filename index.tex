...
\begin{tcolorbox}[enhanced jigsaw, bottomtitle=1mm, colback=white, left=2mm, opacitybacktitle=0.6, toprule=.15mm, coltitle=black, leftrule=.75mm, toptitle=1mm, colframe=quarto-callout-note-color-frame, opacityback=0, titlerule=0mm, breakable, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Shortcut for finding eigen values of 2x2 Matrices}, rightrule=.15mm, arc=.35mm, colbacktitle=quarto-callout-note-color!10!white, bottomrule=.15mm]
...
\begin{tcolorbox}[enhanced jigsaw, bottomtitle=1mm, colback=white, left=2mm, opacitybacktitle=0.6, toprule=.15mm, coltitle=black, leftrule=.75mm, toptitle=1mm, colframe=quarto-callout-note-color-frame, opacityback=0, titlerule=0mm, breakable, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Shortcut for finding eigen values of 3x3 Matrices}, rightrule=.15mm, arc=.35mm, colbacktitle=quarto-callout-note-color!10!white, bottomrule=.15mm]
