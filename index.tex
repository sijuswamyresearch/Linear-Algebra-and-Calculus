...
\begin{tcolorbox}[enhanced jigsaw, toptitle=1mm, colbacktitle=quarto-callout-note-color!10!white, titlerule=0mm, rightrule=.15mm, breakable, arc=.35mm, colframe=quarto-callout-note-color-frame, opacitybacktitle=0.6, coltitle=black, toprule=.15mm, colback=white, opacityback=0, bottomrule=.15mm, bottomtitle=1mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Shortcut for finding eigen values of 2x2 Matrices}, left=2mm, leftrule=.75mm]
...
\begin{tcolorbox}[enhanced jigsaw, toptitle=1mm, colbacktitle=quarto-callout-note-color!10!white, titlerule=0mm, rightrule=.15mm, breakable, arc=.35mm, colframe=quarto-callout-note-color-frame, opacitybacktitle=0.6, coltitle=black, toprule=.15mm, colback=white, opacityback=0, bottomrule=.15mm, bottomtitle=1mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Shortcut for finding eigen values of 3x3 Matrices}, left=2mm, leftrule=.75mm]
