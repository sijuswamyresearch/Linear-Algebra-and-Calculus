...
\begin{tcolorbox}[enhanced jigsaw, left=2mm, colback=white, coltitle=black, colbacktitle=quarto-callout-note-color!10!white, toprule=.15mm, opacitybacktitle=0.6, breakable, bottomrule=.15mm, colframe=quarto-callout-note-color-frame, arc=.35mm, toptitle=1mm, rightrule=.15mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Shortcut for finding eigen values of 3x3 Matrices}, opacityback=0, titlerule=0mm, bottomtitle=1mm, leftrule=.75mm]
