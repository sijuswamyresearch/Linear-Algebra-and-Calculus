...
\begin{tcolorbox}[enhanced jigsaw, colback=white, rightrule=.15mm, arc=.35mm, colframe=quarto-callout-note-color-frame, leftrule=.75mm, left=2mm, toprule=.15mm, opacitybacktitle=0.6, opacityback=0, breakable, coltitle=black, bottomtitle=1mm, toptitle=1mm, bottomrule=.15mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Shortcut for finding eigen values of 2x2 Matrices}, titlerule=0mm, colbacktitle=quarto-callout-note-color!10!white]
...
\begin{tcolorbox}[enhanced jigsaw, colback=white, rightrule=.15mm, arc=.35mm, colframe=quarto-callout-note-color-frame, leftrule=.75mm, left=2mm, toprule=.15mm, opacitybacktitle=0.6, opacityback=0, breakable, coltitle=black, bottomtitle=1mm, toptitle=1mm, bottomrule=.15mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Shortcut for finding eigen values of 3x3 Matrices}, titlerule=0mm, colbacktitle=quarto-callout-note-color!10!white]
